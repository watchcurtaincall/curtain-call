...
interface WriteReviewModalProps {
  ...
  productionId: string;
  reviewType?: 'Critic' | 'Audience';
  onClose: () => void;
}

type Step = 'form' | 'submitting' | 'success';

export function WriteReviewModal({ productionTitle, productionId, reviewType = 'Audience', onClose }: WriteReviewModalProps) {
  const { user } = useAuth();
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      {/* Sheet */}
      <div className="relative w-full sm:max-w-lg bg-zinc-950 border border-white/10 rounded-t-3xl sm:rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="px-6 pb-8 pt-4">
          {step === 'success' ? (
            <div className="flex flex-col items-center text-center py-8 gap-4">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm leading-relaxed">
                  Your review is being processed. It will be live on Curtain Call shortly.
                </p>
              </div>
              <button
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              <div>
                <p className="text-xs text-zinc-500 mb-1">Reviewing</p>
